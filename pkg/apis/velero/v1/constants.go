...
const (
	...
	// OwnerRefRemapFeatureFlag is the feature flag string that defines whether or not dynamic ownerReference remapping and automated quiescing are enabled.
	OwnerRefRemapFeatureFlag = "OwnerRefRemap"
)

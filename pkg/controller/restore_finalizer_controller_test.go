...
func TestOwnerRefRemappingPass2_OriginallyPausedNotCaughtUp(t *testing.T) {
	logger := velerotest.NewLogger()
	fakeClient := velerotest.NewFakeControllerRuntimeClient(t)
...
// TestOwnerRefRemappingPass2_CrashRecoveryFromStatus simulates a Velero pod restart during the
...
func TestOwnerRefRemappingPass2_CrashRecoveryFromStatus(t *testing.T) {
	logger := velerotest.NewLogger()
	fakeClient := velerotest.NewFakeControllerRuntimeClient(t)
...
func TestOwnerRefRemappingPass2_LeftoverCatchUp_SkippedWhenPatchesPending(t *testing.T) {
	logger := velerotest.NewLogger()
	fakeClient := velerotest.NewFakeControllerRuntimeClient(t)
...
func TestOwnerRefRemappingPass2_LeftoverCatchUp_LongRestoreName(t *testing.T) {
	logger := velerotest.NewLogger()
	fakeClient := velerotest.NewFakeControllerRuntimeClient(t)
...
func TestOwnerRefRemappingPass2_FinalizingPartiallyFailed(t *testing.T) {
	logger := velerotest.NewLogger()
	fakeClient := velerotest.NewFakeControllerRuntimeClient(t)
...
func TestOwnerRefRemappingPass2_WithOverflowConfigMap(t *testing.T) {
	logger := velerotest.NewLogger()
	fakeClient := velerotest.NewFakeControllerRuntimeClient(t)
...
func TestOwnerRefRemappingPass2_WithOverflowConfigMap_UnresolvedForcesPartiallyFailed(t *testing.T) {
	logger := velerotest.NewLogger()
	fakeClient := velerotest.NewFakeControllerRuntimeClient(t)

...
func (o *CreateOptions) BindFlags(flags *pflag.FlagSet) {
	...
	flags.StringVar(&o.OwnerRefConfigMap, "owner-ref-restore-configmap", "", "Per-restore ConfigMap of inScope GVKs, specRefPaths, and quiesce rules; unioned onto the server baseline (--owner-ref-configmap). Requires --features=OwnerRefRelink on the server.")
